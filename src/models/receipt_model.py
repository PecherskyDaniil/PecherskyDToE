...
class receipt_model(abstract_reference):
    ...
    __steps:list[step]
    def __init__(self,name:str=None,ingridients:list[proportion]=None,steps:list[step]=None):
        """
        Constructor of class
        name:str
    ...
    def create_wafels_receipt():
        ...
        item=receipt_model.create("Вафли Хрустящие",proportions,steps)
        return item
    ...
    def create_hachapuri():
        ...
        item=receipt_model.create("Хачапури по Адыгейски",proportions,steps)
        return item

    @staticmethod
    def create(name:str,ingridients:list[proportion],steps:list[step]):
        """
        Function that creates receipt
        """
        return receipt_model(name,ingridients,steps)