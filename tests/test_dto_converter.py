...
from src.converters.dto_converter import dto_converter
...
class TestDTOConverter:
    ...
    def test_valid_convert_dto(self,sample_receipt:receipt_model):
        """
        Test create of range_group_dto
        """
        receipt_dto_obj=sample_receipt.to_dto()
        json_obj=dto_converter.convert(receipt_dto_obj)
